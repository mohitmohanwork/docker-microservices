...
namespace Blaash.Gaming.Service.Game.Helpers
{
...

    {
        ...
        public UserModel User => new UserModel() { id = "goo115559040204585310230", first_name= "Hello ", user_id = "goo115559040204585310230" };
